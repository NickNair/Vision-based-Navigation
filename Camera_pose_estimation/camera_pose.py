...
# tvec,rvec [[[0.35928761 1.3310449  3.63792386]]] [[[ 1.24638884 -1.23109941  1.14374023]]]
...
# -0.000520356756169349, -0.0002876412181649357, -0.021140484139323235]]) #ch
    ...
    #########frame capture
    # src = 'rtsp://admin:artpark123@192.168.0.222:554/Streaming/Channels/2/'
    ...
    while True:
        ...
        # frame=cv2.imread('./aruco_images/8.jpg')
        if not status_cam1:
            break
...
if __name__ == '__main__':
    main()
#code looks fine,maybe conversions from one form to anoth migh cause some errors.other than that no other problem
